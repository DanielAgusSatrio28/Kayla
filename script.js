function startFarewell() {
    ...
    // Ganti pesan
    message.textContent = "DIBACA YA IBUU";
    subMessage.textContent = "Untuk Kaya, si Sekum yang baik hati dan tidak sombong. Makasi ya dah mau nemenin jadi bagian dari BPH KKN anjayyy. Maaf kalau gua jadi ketua suka ngerepotin yaa. SEMANGAT KAYY!!! Kalo ketemu dijalan jangan sombong dong parah bgt cok 😊";
    button.textContent = "Tunggu, ada kejutan lagi!";
